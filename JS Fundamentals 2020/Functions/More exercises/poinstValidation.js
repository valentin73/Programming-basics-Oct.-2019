function pointsValidation(coordinates = []) {
    ...
    calculatePointAndStart(coordinates[0], coordinates[1]);
    calculatePointAndStart(coordinates[2], coordinates[3]);
    pointsDistanceCalculator(coordinates[0], coordinates[1],coordinates[2], coordinates[3])
}
